...
public final class Application {
    private static final Pattern PATTERN_COMMAND = Pattern.compile("(exit|start( easy| medium| hard| mm| user){2})");
    private static final Map<String, Player> players = Map.of("user", User::new,
            "easy", Easy::new, "medium", Medium::new, "hard", Hard::new, "mm", MiniMax::new);
